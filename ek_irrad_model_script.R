...
games_howell_test(ulva, supersat_total ~ Treatment, conf.level = 0.95, detailed = TRUE)
...
welch_anova_temp
games_howell_test(hypnea, supersat_total ~ Treatment, conf.level = 0.95, detailed = TRUE)
games_howell_test(hypnea, supersat_total ~ Temperature, conf.level = 0.95, detailed = TRUE)
